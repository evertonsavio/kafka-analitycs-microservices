package dev.evertonsavio.app.kafkaadm.client;

import dev.evertonsavio.app.kafkaadm.exception.KafkaClientException;
import dev.evertonsavio.appconfigdata.KafkaConfigData;
import dev.evertonsavio.appconfigdata.RetryConfigData;
...
@Component
public class KafkaAdmClient {

    public static final Logger LOG = LoggerFactory.getLogger(KafkaAdmClient.class);
    ...
    public KafkaAdmClient(KafkaConfigData kafkaConfigData, RetryConfigData retryConfigData,
